...
if (empty($nambayausajili)) {
 header("Location: below.php?error=empty");
 exit();
}
...
if (empty($number3)) {
 ...
 exit();
    ...
    $file = $_FILES['file'];
 if (empty($file)) {
 header("Location: below.php?error=emptyfile");
 exit();
}
